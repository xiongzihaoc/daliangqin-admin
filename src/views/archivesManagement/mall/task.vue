<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="可得积分"></el-table-column>
      <el-table-column align="center" label="每人每日可完成次数"></el-table-column>
      <el-table-column align="center" label="平台每日发放积分次数"></el-table-column>
