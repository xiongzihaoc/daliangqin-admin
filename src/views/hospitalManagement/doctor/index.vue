<template>
  <div class="app-container">
    ...
    <div class="search-box">
      <el-form ref="searchFormRef" :model="searchForm" :inline="true" class="searchForm">
        ...
        <el-form-item label="身份证号" align="left" prop="idCard">
          <el-input v-model="searchForm.idCard" size="small" placeholder="请输入身份证号" maxlength="18"></el-input>
        </el-form-item>
        ...
        <el-form-item label="职位" align="left" prop="type">
          <el-select v-model="searchForm.type" placeholder="请选择职位" size="small">
            <el-option
    ...
    >
      ...
      <el-table-column align="center" label="出生日期" prop="birthday" :formatter="birthdayFormatter"></el-table-column>
      <el-table-column align="center" label="年龄" prop="age"></el-table-column>
      <el-table-column align="center" label="性别" prop="gender" :formatter="genderFormatter"></el-table-column>
      <el-table-column align="center" label="职位" prop="type" :formatter="typeFormatter"></el-table-column>
