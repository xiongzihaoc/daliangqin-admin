  ...
  <div class="app-container">
    ...
    <div class="search-box">
      ...
      >
        ...
        <el-form-item label="手机号" align="left" prop="name">
          <el-input
            v-model="searchForm.name"
            size="small"
            placeholder="请输入手机号"
        ...
        <el-form-item label="身份证" align="left" prop="name">
          <el-input
            v-model="searchForm.name"
            size="small"
            placeholder="请输入身份证"
        ...
        <el-form-item label="性别" align="left" prop="name">
          <el-select v-model="searchForm.name" size="small">
            <!-- <el-option label="家医"></el-option> -->
          </el-select>
        </el-form-item>
        <el-form-item label="职位" align="left" prop="name">
          <el-input
            v-model="searchForm.name"
            size="small"
            placeholder="请选择职位"
      ...
      >
        ...
        <el-form-item label="职位" prop="type">
          <el-select
            ...
            style="width: 100%"
          >
            <el-option label="家医" value="FAMILY_DOCTOR"></el-option>
            <el-option label="专家" value="HOSPITAL_DOCTOR"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="医院名称" prop="hospitalName">
          <el-select
            v-model="editAddForm.hospitalName"
            placeholder="请选择医院"
            style="width: 100%"
          >
            <el-option
        ...
        <el-form-item label="转诊医生" prop="toDoctor">
          <el-select
            v-model="editAddForm.toDoctor"
            placeholder="请选择转诊医生"
            style="width: 100%"
          >
            <el-option
