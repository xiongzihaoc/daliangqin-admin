  ...
  <div class="app-container">
    ...
    <div class="search-box">
      <el-form ref="searchFormRef" :model="searchForm" class="searchForm" :inline="true">
        <!-- 医生姓名 -->
        <el-form-item label="医生姓名" align="left">
          <el-input
        ...
        <el-form-item label="医生手机号" align="left">
          <el-input
            v-model="searchForm.doctorUserPhone"
            size="small"
            maxlength="11"
        ...
        <el-form-item label="随访方式" prop="type">
          <el-select v-model="searchForm.type" placeholder="请选择随访方式" size="small">
            <el-option
        ...
        <el-form-item>
          ...
          <el-button @click="searchReset" size="small" plain icon="el-icon-refresh"
            >重置</el-button
          >
          <el-button size="small" type="success" icon="el-icon-upload2">导出</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div>
    ...
    >
      <el-form ref="FormRef" :rules="formRules" :model="editAddForm" label-width="100px">
        ...
        <el-form-item label="选择医生" prop="doctorUserId">
          <el-select
            style="width: 100%"
            filterable
            clearable
        ...
        <el-form-item label="选择用户" prop="patientUserId">
          <el-select
            style="width: 100%"
            filterable
            clearable
        ...
        <el-form-item label="随访时间" prop="taskTime">
          <el-date-picker
            class="w100"
...
export default {
  ...
  data() {
    return {
      ...
      formRules: {
        ...
        doctorUserId: [{ required: true, message: "请选择医生", trigger: "blur" }],
        patientUserId: [{ required: true, message: "请选择用户", trigger: "blur" }],
  ...
  methods: {
    ...
    // 获取医生列表
    getDoctorList(id) {
      httpAdminDoctor.getDoctor({ hospitalId: id, pageSize: 10000 }).then((res) => {
    ...
    // 删除
    async deleteBtn(id) {
      const confirmResult = await this.$confirm("你确定要执行此操作, 是否继续?", "提示", {
