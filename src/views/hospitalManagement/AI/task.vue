<template>
    <div class="app-container">
        ...
        <div>
            <el-button @click="addTask" type="primary" size="small" plain icon="el-icon-plus">添加任务</el-button>
        </div>
        <!-- 表格 -->
        <EleTable
            :data="list"
        ...
        >
            ...
            <el-table-column align="center" label="操作">
                <template slot-scope="scope">
                    <el-dropdown size="medium" @command="operation">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item command="开始任务">开始任务</el-dropdown-item>
                            <el-dropdown-item command="暂停任务">暂停任务</el-dropdown-item>
                            <el-dropdown-item command="中止任务">中止任务</el-dropdown-item>
                            <el-dropdown-item command="运营概况">运营概况</el-dropdown-item>
                            <el-dropdown-item command="问题统计">问题统计</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </template>
            </el-table-column>
    ...
    methods: {
        ...
        confirmCallTime() {
            ...
            if (period.length === 7) {
                ...
                this.searchForm.setTime = `${period.join('、')}/${this.searchForm.daily[0]
                    }~${this.searchForm.daily[1]}`
            }
        },
        // 任务选择
        getTask() {
