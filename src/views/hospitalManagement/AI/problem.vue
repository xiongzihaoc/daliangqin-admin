  ...
  <div class="app-container">
    ...
    <div class="search-box">
      <el-button-group style="margin-bottom: 15px;">
        <el-button size="small" type="primary" @click="checkBtn('date')">按日期查看</el-button>
        <el-button size="small" type="primary" @click="checkBtn('stage')">按期名查看</el-button>
      </el-button-group>
    ...
    >
      <el-table-column
        ...
        type="index"
      ></el-table-column>
      <el-table-column v-if="show" width="150px" align="center" label="日期" prop="startTime">
      ...
      <el-table-column align="center" label="外呼总量(位)" prop="callTotal"></el-table-column>
